    ...
    if(displaySocialInputs) {
      socialInputs = (
        <div>
          ...
          />
          <InputGroup
            placeholder="Linkedib Profile URL"
            name="linkedin" 
              ...
              <h1 className="display-4 text-center">Edit Profile</h1>               
                ...
                <form onSubmit={this.onSubmit}>
                  ...
                  <SelectListGroup 
                    ...
                    options={options}
                    error={errors.status}
                    info="Give us an idea of where you are at at in your career"
                  />
                  <TextFieldGroup 
                    placeholder="Company"
                    name="company"
                  ...
                  />
                   <TextFieldGroup 
                    ...
                    info="Could or city & state suggested"
                  />
                   <TextFieldGroup 
                    placeholder="Skills"
                    name="skills"
                    ...
                    onChange={this.onChange}
                    error={errors.skills}
                    info="Please use comma separated values (eg. HTML,CSS)"
                  />
                   <TextFieldGroup 
